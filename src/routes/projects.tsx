...
const projects: ProjectDetailed[] = [
  {
    id: 1,
    title: "Storymark",
    subtitle: "Storybook but for .md files",
    description: "a React-based UI with backend adapters for Next.js and Vite.",
    role: "Full Stack Engineer",
    tags: ["Vite", "NextJS", "npm", "Typescript"],
    imageUrl: "/images/storymark.png",
    repoUrl: "https://github.com/lavizp/storymark",
    liveUrl: "https://storymark.lavizpandey.com.np/docs",
    color: "bg-indigo-500"
  },
  {
    id: 2,
    title: "Spot the Quote",
    subtitle: "Guess the coding language",
    description: "Programming style geoguesser clone, with realtime features for multiplayer",
    role: "Front End Engineer",
    tags: ["Node.js", "React JS", "Socket.io", "Typescript"],
    imageUrl: "/images/spot.png",
    repoUrl: "https://github.com/lavizp/spot-the-code",
    liveUrl: "https://spot-the-code.lavizpandey.com.np/",
  ...
  },
  {
    ...
    liveUrl: "https://github.com/lavizp/gyanarthi-fe",
    color: "bg-indigo-500"
  },
];
