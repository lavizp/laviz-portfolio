...
const projects: ProjectDetailed[] = [
  {
    ...
    description: "High-performance data visualization platform handling millions of data points. Features a custom virtualized grid engine and WebGL-powered charts.",
  ...
  },
  {
    id: 2,
    title: "Echo",
    subtitle: "Encrypted Messaging Protocol",
    description: "Zero-knowledge proof messaging application. Implements end-to-end encryption with double-ratchet algorithms for forward secrecy.",
  ...
  },
  {
    id: 3,
    title: "Aura",
    subtitle: "DeFi Asset Manager",
    description: "Comprehensive crypto asset dashboard. Tracks multi-chain portfolios with real-time price feeds and predictive yield modeling via smart contracts.",
    role: "Smart Contract Integrator",
    tags: ["Web3", "Solidity", "Next.js", "Ethers.js"],
